...
from stagecoach.outpost import create_outpost
...
class StageCoach:
    ...
    def hail(
        ...
        outpost : bool, default=False
            Whether to create a temporary mock Frontier citizenship scaffold for
            manifest creation outside the assigned Frontier.
        ...
        if outpost:
            ...
            banner(
                console,
                "Using Outpost mode for manifest creation. ⛺"
                "Stagecoach will create a temporary mock Frontier file for the "
                "citizenship check, allowing the Stagecoach to "
                "ferry the data to a fictional Frontier."
            )

        outpost = create_outpost() if outpost else nullcontext()
