...
params:
    export: true
format: gfm
guide-section: "For Developers: `stagecoach` Internals"
---
...
The checks are designed to be simple and easy to implement, and 
each one's code is documented below. If you believe
a particular check needs to be implemented or improved, please
submit a [Pull Request](https://github.com/GoldenPlanetaryHealthLab/stagecoach/pulls)!
